                    ...
                    <div class="container-fluid">
                        ...
                        <nav class="navbar-custom">
                            ...
                            <ul class="list-unstyled topbar-right-menu float-right mb-0">
                                ...
                                <li class="hide-phone">
                                    <form class="app-search" action="cari.php" method="POST">
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div class="user-box">
                        ...
                        <!-- <h5><a href="#"><?php print_r($_SESSION['user']['username']); ?></a> </h5> -->
...
<li class="has_sub">    
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="<?php echo $cfg_baseurl; ?>settings.php?id=<?php echo $iduser; ?>">Pengaturan</a>
                                    </li>
...
<!--                              <li class="has_sub">
              ...
              <ul class="list-unstyled">
                                    <li>
                                        <form action="<?php echo $cfg_baseurl; ?>admin/users.php" method="POST">
                                            <input type="hidden" name="level" value="<?php echo $data_user['level']; ?>">
                                            <button class="btn btn-success">Kelola User</button>
                                        </form>
                                    </li>
                                    <li>
...
<li class="has_sub">
              ...
              <ul class="list-unstyled">
                            ...
                            ?>
                            <li>
                                <a href="<?php echo $cfg_baseurl; ?>dev2.php?id=dev.php" class="waves-effect"><i class="fa fa-phone"></i> <span> Kontak Developer </span> </a>
                            </li>
<li class="has_sub">
...
<li class="has_sub">
              ...
              <ul class="list-unstyled">
                                               <li><a href="<?php echo $cfg_baseurl; ?>price_list.php?id=time"> <i class="fa fa-angle-right"></i> <span>Sosmed</span> </a></li>
                                        ...
                                        <li>
                                <a href="<?php echo $cfg_baseurl; ?>terms.php?command=" class="waves-effect"><i class="fa fa-info icon"></i> <span> Ketentuan </span> </a>
                            </li>
          </ul>
